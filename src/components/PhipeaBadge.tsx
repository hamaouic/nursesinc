 ...
 * Hidden when a preview drawer is open (body.has-drawer-open class).
 */
export default function PhipeaBadge() {
  return (
    <div className="phipea-badge pointer-events-none fixed inset-x-0 bottom-3 z-40 flex justify-center px-3 transition-opacity duration-200">
